...
public class PageController {
	...
	public String pages(Model model) {
		List<Post> posts = postService.findAllPosts(NanoConst.POST_TYPE_PAGE);
	...
	public void pushPage(@ModelAttribute Post post, HttpSession session) {
		try {
			...
			post.setUser(user);
			post.setPostType(NanoConst.POST_TYPE_PAGE);
