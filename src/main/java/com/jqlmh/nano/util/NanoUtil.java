...
public class NanoUtil {
	...
	public static String getRss(List<Post> posts) throws FeedException {
		...
		if (null == NanoConst.OPTIONS.get("blog_title")) {
			channel.setTitle("");
		} else {
			channel.setTitle(NanoConst.OPTIONS.get("blog_title"));
		}
		if (null == NanoConst.OPTIONS.get("blog_url")) {
			channel.setLink("");
		} else {
			channel.setLink(NanoConst.OPTIONS.get("blog_url"));
		}
		if (null == NanoConst.OPTIONS.get("seo_desc")) {
			channel.setDescription("");
		} else {
			channel.setDescription(NanoConst.OPTIONS.get("seo_desc"));
		}
		...
		for (Post post : posts) {
			...
			item.setLink(NanoConst.OPTIONS.get("blog_url") + "/archives/" + post.getPostUrl());
	...
	public static String getSiteMap(List<Post> posts) {
		...
		String urlBody = "";
		String urlItem;
		String urlPath = NanoConst.OPTIONS.get("blog_url") + "/archives/";
		for (Post post : posts) {
