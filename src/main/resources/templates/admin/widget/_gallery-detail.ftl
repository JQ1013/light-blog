                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="galleryDate" name="galleryDate"
                                               value="${gallery.galleryDate}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="galleryLocation" class="col-sm-2 control-label">拍摄地点：</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="galleryLocation"
                                               name="galleryLocation" value="${gallery.galleryLocation}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="galleryUrl" name="galleryUrl"
                                               value="${gallery.galleryUrl}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="box-footer">
                                <button type="button" class="btn btn-danger btn-sm pull-left" onclick="btn_delete()">
                                    永久删除
                                </button>
                                <button type="button" class="btn btn-info btn-sm pull-right" onclick="btn_save()">保存
                                </button>
                            </div>
                        </form>
                    </div>
