<header class="main-header">
    <a href="/admin" class="logo">
        ...
        <span class="logo-lg"><b>Na</b>no</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                                        ...
                                        <#list newComments?sort_by("commentDate")?reverse as comment>
                                            ...
                                            <li>
                                                <a href="/admin/comments?status=1">
                                                    <div class="pull-left">
                                                        <img src="https://secure.gravatar.com/avatar/${comment.commentAuthorAvatarMd5?default("hash")}?s=256&d=${options.native_comment_avatar?default("mm")}"
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<#if user_session.userAvatar?if_exists!="">${user_session.userAvatar}<#else >/static/images/default.png</#if>"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left"><a data-pjax="true" href="/admin/profile" class="btn btn-default "><i
