                        ...
                        <div class="tab-content">
                                ...
                                <form method="post" class="form-horizontal" id="anatoleSnsOptions">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="anatoleSnsTwitter"
                                                   class="col-sm-4 control-label">Twitter：</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="anatoleSnsFacebook"
                                                   class="col-sm-4 control-label">Facebook：</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="anatoleSnsInstagram"
                                                   class="col-sm-4 control-label">Instagram：</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="anatoleSnsDribbble"
                                                   class="col-sm-4 control-label">Dribbble：</label>
                                            <div class="col-sm-8">
                            ...
                            <div class="tab-pane" id="style">
                                <form method="post" class="form-horizontal" id="anatoleStyleOptions">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="anatoleStyleFavicon"
                                                   class="col-sm-4 control-label">Favicon：</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="anatoleStyleFavicon"
                                                           name="anatole_style_favicon"
                                                           value="${options.anatole_style_favicon?default("/anatole/source/images/favicon.png")}">
                                                    <span class="input-group-btn">
                                                <button class="btn btn-default btn-flat" type="button"
                                                        onclick="openAttach('anatoleStyleFavicon')">选择</button>
                                            </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="anatoleStyleHitokoto"
                                                   class="col-sm-4 control-label">博客描述开启一言：</label>
                                            <div class="col-sm-8">
                                                <label class="radio-inline">
                                                    <input type="radio" name="anatole_style_hitokoto"
                                ...
                                <div class="box box-widget widget-user-2">
                                    <div class="widget-user-header bg-blue">
                                        <div class="widget-user-image">
                                            <img class="img-circle" src="/anatole/source/images/nano@2X.jpg"
                                                 alt="User Avatar">
                                        </div>
                                        <h3 class="widget-user-username">anshen</h3>
                                        <h5 class="widget-user-desc">A fantastic theme</h5>
                                    </div>
                                    <div class="box-footer no-padding">
                                        <ul class="nav nav-stacked">
                                            <li><a target="_blank" href="https:/jqlmh.com/">作者主页</a></li>
                                            <li><a target="_blank"
                                                   href="https://github.com/hi-caicai/farbox-theme-Anatole">原主题地址</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
